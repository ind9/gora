...
public class HBaseStore<K, T extends Persistent> extends DataStoreBase<K, T>
    ...
    public void put(K key, T persistent) throws IOException {
        putInternal(key, persistent, true);
    }

    public void put(K key, T persistent, boolean writeToWal) throws IOException {
        putInternal(key, persistent, writeToWal);
    }

    private void putInternal(K key, T persistent, boolean writeToWal) throws IOException {
