...
public class HBaseByteInterface {
    ...
    public static final EncoderFactory encoderFactory = new EncoderFactory();
    ...
    public static byte[] toBytes(Object o, Schema schema) throws IOException {
        ...
        switch (type) {
            ...
            case RECORD:
                ...
                Encoder encoder = encoderFactory.binaryEncoder(new ByteArrayOutputStream(), null);
                writer.write(o, encoder);
                encoder.flush();
                byte[] outputBytes = new byte[]{};
                encoder.writeBytes(outputBytes);
                return outputBytes;
            default:
                throw new RuntimeException("Unknown type: " + type);
        }
